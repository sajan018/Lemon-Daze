    ...
    return (
        <div class="bg-white">
            <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                <div>
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Summer Collection Highlights</h2>
                ...
                <div class="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
                    <img src="tshirt.png" alt="Walnut card tray with white powder coated steel divider and 3 punchout holes." class="rounded-full p-10 bg-yellow-50 opacity-50" />
                    <img src="kurti.png" alt="Top down view of walnut card tray with embedded magnets and card groove." class="rounded-2xl bg-yellow-50" />
                    <img src="saree.png" alt="Walnut card tray filled with cards and card angled in dedicated groove." class="rounded-2xl bg-yellow-50" />
                    <img src="jeans.png" alt="Side of walnut card tray with card groove and recessed card area." class="rounded-full bg-yellow-50 opacity-50" />
